...
class ContactStatusModule:
    ...
    def run(self, portfolio: pl.DataFrame) -> Dict:
        ...
        # 6. كلمات مفتاحية توصل في نص (الرئيسية + الفرعية) فقط
        ...
        status_expr = (
            ...
            # 2. الحالة الرئيسية توصل صريح
            .when(is_contacted_main).then(pl.lit(CONTACTED))
            # 3. الحالة الرئيسية عدم توصل
